    ...
    public class clsDogClass
    {
        ...
        internal void Load(int dogClassID)
        {
            ...
            try
            {
                string sqlCmd = @"SELECT ShowEntryID
                              ...
                              ,SpecialRequest
                          FROM tblDogClasses
                          WHERE DogClassID = @DogClassID AND ShowEntryID = @ShowEntryID";
                ...
                adr.SelectCommand.Parameters.AddWithValue("@EntryID", _showentryID);
        ...
        internal void Save()
        {
            try
            {
                ...
                command.Parameters.AddWithValue("@EntryID", _showentryID);
        ...
        private int GetDogClassID()
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@EntryID", _showentryID);
        ...
        internal DataTable GetEnteredClasses()
        {
            ...
            string sqlCmd = @"SELECT e.EntryID
                              ...
                              ,ClassCap
                              ,Judges
                          FROM tblShowEntries se 
                          INNER JOIN tblDogClasses dc ON se.ShowEntryID = dc.ShowEntryID
                          INNER JOIN tblEventEntries ee ON se.EventEntryID = ee.EventEntrID
