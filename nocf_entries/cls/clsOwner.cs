...
namespace nocf_entries.cls
{
    public class clsOwner
    {
        ...
        public clsOwner(string ownerID, string username, string email)
        {
            _ownerID = ownerID;
            _userName = username;
            _email = email;
        ...
        internal void Load()
        {
            try
            {
                ...
                Country, Phone, Mobile FROM tblOwners WHERE OwnerID = @OwnerID";
        ...
        internal void Save()
        {
            try
            {
                string sqlCmd = @"UPDATE  tblOwners SET Title = @Title, FirstName = @FirstName, LastName = @LastName, 
                            ...
                            Mobile = @Mobile WHERE OwnerID = @OwnerID";
